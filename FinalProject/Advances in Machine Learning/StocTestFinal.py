...
class BackTestor:
    ...
    def in_sample_calculate_pnl(self, thres , in_out_ratio=.8, maximum_trading = 3):
        ...
        ax1.plot(mdd_lst)
        plt.show()
        df.to_csv(r'C:\Users\John\OneDrive\바탕 화면\School\24Spring\수프밍\project\data\entrance_exit_in.csv')


backtestor = BackTestor(kq150_data,scope_length=10 , maximum_holding_period = 5)
